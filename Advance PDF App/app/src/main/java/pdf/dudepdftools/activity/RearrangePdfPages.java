...
import pdf.dudepdftools.adapter.RearrangePdfAdapter;
import pdf.dudepdftools.util.Constants;
import pdf.dudepdftools.util.DialogUtils;
import pdf.dudepdftools.util.ThemeUtils;

import static pdf.dudepdftools.util.Constants.CHOICE_REMOVE_IMAGE;
import static pdf.dudepdftools.util.Constants.RESULT;
import static pdf.dudepdftools.util.Constants.SAME_FILE;
