...
import static pdf.dudepdftools.util.Constants.WORD_TO_PDF_KEY;
...
public class FavouritesFragment extends Fragment
    ...
    @BindView(R.id.word_to_pdf_fav)
    MyCardView pref_word_to_pdf;
    ...
    private void initializeValues() {
        ...
        pref_word_to_pdf.setOnClickListener(this);
    ...
    private void checkFavourites(SharedPreferences sharedPreferences) {
        ...
        viewVisibility(pref_word_to_pdf, WORD_TO_PDF_KEY);
